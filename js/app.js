$(window).on("load", function () {
	...
	const askedName = prompt("Oắt do nêm?");
	...
	var typed = new Typed("#text", {
		strings: [
			"Happy Vietnamese Women's Day! I hope you're doing well and feeling happy. I just wanted to wish you all the best on this special day. May you have lots of success and happiness in your life, and stay healthy all year long.  <br> <b>So keep shining and smiling because you are so cute and so beautiful! <3 <3</b>",
		],
		startDelay: 4500,
		typeSpeed: 92,
		loop: false,
